...
ADD CONSTRAINT fkt_emp_tip      FOREIGN KEY     (id_empresa)    REFERENCES  empresas (id_empresa),
...
ADD CONSTRAINT fkh_idescu       FOREIGN KEY    (id_escuela)     REFERENCES escuelas_samba(id_escuela),
...
ADD CONSTRAINT fkca_prota       FOREIGN KEY    (id_prota)      REFERENCES protagonistas(id_prota);
